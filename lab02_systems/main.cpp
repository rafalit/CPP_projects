...
constexpr const char* const FIRSTNAME = "Rafal";
constexpr const char* const SURNAME   = "Szarowicz";
constexpr const char* const MAIL    = "rafszarowicz@student.agh.edu.pl";
constexpr const char* const BOOK_ID = "416155";
